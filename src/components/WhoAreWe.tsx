...
function WhoAreWe() {
  return (
    <Container>
        ...
        <Description>
            <p>
                Hola! Somos la <Bold>selección de Ajedrez UC</Bold>.
            ...
            <span>
                ...
                Disponible para ir de oyente los días <Bold>lunes y miércoles de 18:30 a 20:50 hrs</Bold>.
            </span>
            <span>
                <Icon className="fa fa-map-marker" style={{fontSize: "1.5rem"}}></Icon>
                Estamos ubicados en la <Bold>Sala Corporal N°3</Bold>, tercer piso de deportes.
            </span>
            <span>
