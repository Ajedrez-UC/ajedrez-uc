    ...
    <Container>
      ...
      <Description>
        <p>
          Hola! Somos la{" "}
          <Bold>
            selección de Ajedrez de la Pontificia Universidad Católica de Chile
          </Bold>
          . Nuestro objetivo es promover el ajedrez en la universidad y en la
          comunidad.
        </p>
        {/* 
            <span>
        ...
        <span>
          ...
          ></Icon>
          Estamos ubicados en la <Bold>Sala Corporal N°3</Bold>, tercer piso de
          deportes, Campus San Joaquín.
        </span>
        <span>
